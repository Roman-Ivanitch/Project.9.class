...
#define WIFI_SSID               "XXXXXX"  //Имя точки доступа WIFI VVK   AndroidAP
#define WIFI_PASS               "XXXXXX" //пароль точки доступа WIFI vtb24admin 1234567890

/*
     Blynk Auth Code
*/
#define AUTH                      "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"
